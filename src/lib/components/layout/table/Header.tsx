...
const Header: React.FC<Props> = ({
	...
	return (
		<Cell kind='header' size={size}>
			{header.isSortable ? (
				<button
					className={`flex w-full items-center ${commonLayoutClasses} ring-1 ring-inset ring-transparent transition-colors duration-150 focus:outline-none focus:ring-white hover:bg-gray-700 ${
