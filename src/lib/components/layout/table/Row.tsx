...
const Row: React.FC<Props> = ({
	...
	return (
		<tr className='group:hover border-b-2 border-zinc-700 transition duration-150 last:border-transparent hover:bg-zinc-800'>
			{hasSelection && (
				...
				<Cell kind='body' size={size}>
					{row.actions.length >= 5 ? (
						<div className='relative'>
							...
							/>
							{isMenuActive && (
								<ul className='absolute top-10 right-0 z-20 w-48 border-2 border-zinc-700'>
