...
const Toast: React.FC<Props> = ({
	...
	return (
		<>
			<li className='shadow-stack flex w-80 max-w-full items-start justify-between border-2 border-t-4 border-gray-700 bg-gray-900 p-3'>
				<div className='flex w-4/5 items-start'>
					...
					<div className='ml-3'>
						<header>
							...
							<p className='mt-1.5 break-words text-gray-300'>{description}</p>
						</header>
						<div className='mt-3'>
							<slot name='action' />
						</div>
